...
//     await f_project.get_all();    
//     await f_task.get_all();
//     _projects.forEach(current => {
...
//     // getProjects: async () => {
//     //     let data = [];
//     //     let res = await getJson(`/projects/get?testing=${TESTING}`);
//     //     if(res) {
...
//     //     const res = await fetch(backend + `/projects/add?testing=${TESTING}`, {
//     //         method: "POST",
...
//     //     const res = await fetch(backend + `/tasks/add/${project_id}?testing=${TESTING}`, {
//     //         method: "POST",
...
//     //     const res = await fetch(backend + `/sections/add/?testing=${TESTING}`, {
//     //         method: "POST",
//     //         body: JSON.stringify({
//     //             title: title
//     //         }),
...
//     //     const res = await fetch(backend + `/tasks/edit?testing=${TESTING}`, {
//     //         method: "PUT",
...
//     //     const res = await fetch(backend + `/projects/edit?testing=${TESTING}`, {
//     //         method: "PUT",
//     //         body: JSON.stringify(project),
//     //         headers: {
//     //             "Content-type": "application/json; charset=UTF-8",
...
//     //         new_title: new_value,
//     //     }
//     //     const res = await fetch(backend + `/sections/edit?testing=${TESTING}`, {
//     //         method: "PUT",
//     //         headers: {
//     //             "Content-type": "application/json; charset=UTF-8",
//     //             ...details
...
//     //     const res = await fetch(backend + `/tasks/deletet?testing=${TESTING}`, {
//     //         method: "DELETE",
//     //         headers: {
//     //             "Content-type": "application/json; charset=UTF-8",
//     //             task_id
...
//     //     const res = await fetch(backend + `/projects/delete?testing=${TESTING}`, {
//     //         method: "DELETE",
//     //         headers: {
//     //             "Content-type": "application/json; charset=UTF-8",
//     //             project_id
...
//     //     let res = await fetch(backend + `/tasks/set-finished?task_id=${task_id}&testing=${TESTING}`, {
//     //         method: "PUT",
